...
ActiveRecord::Schema.define(version: 2020_08_21_023010) do
  ...
  create_table "courses", force: :cascade do |t|
    ...
    t.index ["uuid_token"], name: "index_courses_on_uuid_token", unique: true
  end
  ...
  create_table "users", force: :cascade do |t|
    t.uuid "uuid_token", default: -> { "gen_random_uuid()" }, null: false
    t.uuid "secure_token", default: -> { "gen_random_uuid()" }, null: false
